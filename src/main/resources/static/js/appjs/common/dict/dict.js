...
function selectLoad() {
	var html = "";
	$.ajax({
		url : '/common/sysDict/type',//数据字典的查询页面的类型选择
		success : function(data) {
			...
			$('.chosen-select').on('change', function(e, params) {
				console.log(params.selected);//在控制台输出日志信息。
				var opt = {
					query : {
