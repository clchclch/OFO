						...
						columns : [
								...
								},
								{
                                    ...
                                    formatter:function (value,row,index) {
                                        return '<a href="#" onclick="preview(\''+ row.discoverId+ '\')">'+row.discoverTitle+'</a>';
                                    }
                                },
								{
									field : 'discoverImageUrl',
									title : '图片地址'
								},
								{
									field : 'discoverType',
...
function preview(id) {
	window.open("/blog/bContent/open/post/"+id);   
